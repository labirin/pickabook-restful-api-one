...
export async function getAllPost(req,res,next)
{
  ...
  // whAT IS PROMISE[0]
  //console.log('what us promise[0]: ', promise[0])
 // console.log('what us promise[1]: ', promise[1])
...
// export async function getPostbyUserId(req,res,next)
// {
//   console.log('current user is ',req.user)
//   const limit=parseInt(req.query.limit)
//   const skip=parseInt(req.query.skip)
...
//   const userId=promise[0]._id

//   const userPosts = [];

// 	promise[1].forEach(obj => {
...
*/
  ...
  // ,{$project:
  //   {title:1,writer:1,isbn:1,user:1,favoriteCount:1,createdAt:1,tags:1,pics:1,categoryIndex:1,
